# LP -- Ana Cristina Schneider

Repositorio standalone da landing page de Ana Cristina Schneider.
...
- **Cliente:** Ana Cristina Schneider
- **GitHub:** https://github.com/emaildozotti/Ana-Cristina-Schneider
- **Vercel:** https://ana-cristina-schneider.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Ana Cristina Schneider ao ar"
...
- O remote `origin` = `emaildozotti/Ana-Cristina-Schneider` -- nao alterar
